...
const Describe = ({ data }) => {
  ...
  return (
    <section className="text-black bg-gray-100
     relative w-full py-4 sm:py-10 md:py-12 lg:py-6">

      <div className="max-w-7xl mx-auto bg-gray-100 px-4">
        <div className=" rounded-lg overflow-hidden ">
          {/* Main Content Section */}
          <div className="flex flex-col justify-center text-black rounded-lg">
            <h1
              className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 text-main"
              data-aos="fade-up"
            >
              {data?.name}
            </h1>
            ...
            <p
              className="text-sm sm:text-base md:text-lg text-black opacity-90 mb-6 text-justify"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              {data?.description}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 ">
              {data?.features.map((val,index)=>{
                 return(
                  ...
                  <div>
                    <h3 className="font-semibold md:text-xl text-lg">{val}</h3>
